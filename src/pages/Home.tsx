...
export const Home = () => {
  ...
  const doneTask = useCallback(async (index: number) => {
  ...
  }, [deleteTodo, getAllTodos, taskIndex, tasks]);
  ...
  return (
    <Column width="600px" margin="0 auto">
      ...
      <List items={tasks} selectedIndex={taskIndex} onClick={setTaskIndex} setTaskDone={doneTask} deleteTask={deleteTask}/>
    </Column>
  );
};
